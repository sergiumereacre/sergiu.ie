      ...
      <main className="bg-white px-10 md:px-20 lg:px-30">
        <section>
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className=" text-2xl font-poppins">sergiu</h1>
          ...
          <div className="text-center p-10">
            ...
            <p className='text-md py-5 leading-7 text-gray-800 md:max-w-lg mx-auto'>
          ...
          <ul className='text-5xl flex justify-center gap-10 py-3 text-gray-600'>
            <li>
        ...
        <section className='px-5 md:px-20'>
          <div>
            <h3 className='text-2xl py-2 pt-9'>Professional Experience</h3>
          ...
          <div className='lg:flex gap-10'>
            <div>
              <div className='text-center shadow-lg p-10 rounded-xl my-10 transition-all duration-300 hover:shadow-2xl'>
                <Image src={code} width={100} height={100}/>
                <h3 className='text-lg font-medium pt-6 pb-1'>Coding Projects</h3>
                <p className='py-2'>
                ...
                <h4 className='py-3 text-teal-600'>Coding lanugages I've used in the past.</h4>
            ...
            <div>
              <div className='text-center shadow-lg p-10 rounded-xl my-10 transition-all duration-300 hover:shadow-2xl'>
                ...
                <h3 className='text-lg font-medium pt-6 pb-1'>Beautiful Designs</h3>
                <p className='py-2'>
                ...
                <h4 className='py-3 text-teal-600'>Design tools I use.</h4>
            ...
            <div>
              <div className='text-center shadow-lg p-10 rounded-xl my-10 transition-all duration-300 hover:shadow-2xl'>
                ...
                <h3 className='text-lg font-medium pt-6 pb-1'>Team Collaboration</h3>
                <p className='py-2'>
                ...
                <h4 className='py-3 text-teal-600'>Skills acquired.</h4>
